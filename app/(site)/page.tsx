...
import { Encuentros } from "@/components/home/Encuentros";
...
export default async function HomePage() {
  const [faqItems, testimonialItems, slides, events] = await Promise.all([
    getFaqs(),
    getTestimonials(),
    listCarouselSlides(),
    listEvents(),
  ...
  return (
    <>
      ...
      <Approach />
      <Programs />
      <Encuentros slides={slides} events={events} />
